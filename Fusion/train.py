...
from model import FusionTLTRModel, TLTRModel
...
@click.command()
@click.option('-p', '--config_path', default='/home/adas/Projects/Wav_LM/Fusion/config.yml', type=str)
...
def main(config_path):
    ...
    params = list(model.mlp_layer.parameters())
    optimizer = torch.optim.Adam(params, lr=lr, weight_decay=weight_decay, betas=(0.9, 0.99), eps=1e-09)
