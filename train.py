...
@click.command()
@click.option('-p', '--config_path', default='/home/adas/Projects/Wav_LM/Configs/config.yml', type=str)
...
def main(config_path):
    ...
    model = EmoWizard(checkpoint_path=checkpoint_path, feature_len=feature_len, dim_out=regressor_dim_out)
